...
#ifndef LIFTEMPO_SWIFT_H
#define LIFTEMPO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="liftempo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class WCSession;
@class NSString;
SWIFT_CLASS("_TtC8liftempo17PhoneConnectivity")
@interface PhoneConnectivity : NSObject <WCSessionDelegate>
